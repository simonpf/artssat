...
class Tropical(DataProviderBase):
    ...
    def __init__(self, p = None, z = None):
        ...
        self.pi = p
        self.zi = z
        self.p  = np.array([ 100000.        ,   79432.82347243,   63095.73444802,
        ...
        self.z = np.array([119.26605505,  2118.57516973,   4027.60345297,   5862.87711004,
    ...
    def get_temperature(self, *args, **kwargs):
        t = np.array([ 298.98440367,  287.22569932,  276.81505687,  264.51872336,
    ...
    def get_CO2(self, *args, **kwargs):
        co2 = np.array([ 0.0003685 ,  0.0003685 ,  0.0003685 ,  0.0003685 ,  0.0003685 ,
    ...
    def get_H2O(self, *args, **kwargs):
        h2o = np.array([  2.51821658e-02,   1.45514777e-02,   4.41302228e-03,
    ...
    def get_N2O(self, *args, **kwargs):
        n2o = np.array([  3.20250799e-07,   3.20251239e-07,   3.20164327e-07,

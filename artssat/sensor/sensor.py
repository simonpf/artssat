...
class Sensor(ArtsObject):
    ...
    @arts_property("Vector", shape=(dim.Joker,), wsv=wsv["f_grid"])
    def f_grid(self):
        """
    ...
    @arts_property("String", wsv=wsv["iy_unit"])
    def iy_unit(self):
        """
    ...
    @arts_property("ArrayOfString", shape=(dim.Joker,), wsv=wsv["iy_aux_vars"])
    ...
    @arts_property("Matrix", shape=(dim.Joker, dim.Atm), wsv=wsv["sensor_pos"])
    ...
    @arts_property("Matrix", shape=(dim.Joker, dim.Atm), wsv=wsv["transmitter_pos"])
    ...
    @arts_property("Matrix", shape=(dim.Obs, dim.Los), wsv=wsv["sensor_los"])
    ...
    @arts_property("Matrix", shape=(dim.Obs, dim.Los), wsv=wsv["mblock_dlos_grid"])
    ...
    @arts_property("Sparse", shape=(dim.Joker, dim.Joker), wsv=wsv["sensor_response"])
    ...
    @arts_property("Vector", shape=(dim.Joker,), wsv=wsv["sensor_response_f"])
    ...
    @arts_property("ArrayOfIndex", shape=(dim.Joker,), wsv=wsv["sensor_response_pol"])
    ...
    @arts_property(
        "Vector", shape=(dim.Joker, dim.Joker), wsv=wsv["sensor_response_dlos"]
    )
    ...
    @arts_property("Vector", shape=(dim.Joker,), wsv=wsv["sensor_response_f_grid"])
    ...
    @arts_property(
        "ArrayOfInteger", shape=(dim.Joker,), wsv=wsv["sensor_response_pol_grid"]
    )
    ...
    @arts_property("Vector", shape=(dim.Joker,), wsv=wsv["sensor_response_dlos_grid"])
    ...
    @arts_property("Vector", shape=(dim.Joker,), wsv=wsv["sensor_time"])
    ...
    @arts_property("Index", wsv=wsv["sensor_norm"])
    ...
    @arts_property("Index", wsv=wsv["antenna_dim"])
    ...
    def setup(self, ws, scattering=True):
        ...
        if ws.scat_data_raw.initialized:
            ws.scat_dataCalc(
                scat_data_raw=ws.scat_data_raw, f_grid=wsvs["f_grid"], interp_order=1
            )
...
class NoSensor(ArtsObject):
    ...
    def __init__(self, f_grid, stokes_dimension=1, iy_aux_vars=[]):
        """
        Paramters:
    ...
    def iy_unit_setter(self, u):
        ...
        if not u in valid:
            raise Exception(
                "Value of iy_unit for an active sensor must"
    ...
    def iy_aux_vars_setter(self, v):
        ...
        if not type(v) == list:
            v = [v]
        if not all([u in ["Radiative background", "Optical depth"] for u in v]):
            raise Exception(
                "Value of iy_aux_vars for an active sensor must"
    ...
    def get_data(self, ws, data_provider, *args, **kwargs):
        ...
        """
        self.get_data_arts_properties(ws, data_provider, *args, **kwargs)
        self.call_wsm(ws, wsm["sensorOff"])
        self.call_wsm(ws, wsm["sensor_checkedCalc"])
...
class ActiveSensor(Sensor):
    ...
    @property
    def y_vector_length(self):
        return (len(self.range_bins) - 1) * len(self.f_grid) * self.stokes_dimension
    ...
    def make_y_calc_function(self, append=False, scattering=False):
        ...
        if append:
            raise Exception(
                "ARTS doesn't support appending measurements from" " active sensors."
            )
...
class PassiveSensor(Sensor):
    ...
    def make_y_calc_function(self, append=False, scattering=False):
        ...
        def y_calc_append(ws):
            ws.yCalcAppend(**kwargs, jacobian_quantities_copy=ws.jacobian_quantities)
...
class ICI(PassiveSensor):
    ...
    channels = np.array(
        [
            1.749100000000000e11,
            1.799100000000000e11,
            1.813100000000000e11,
            2.407000000000000e11,
            3.156500000000000e11,
            3.216500000000000e11,
            3.236500000000000e11,
            4.408000000000000e11,
            4.450000000000000e11,
            4.466000000000000e11,
            6.598000000000000e11,
        ]
    )
...
class MWI(PassiveSensor):
    ...
    def __init__(self, name="mwi", channel_indices=None, stokes_dimension=1):
        """
